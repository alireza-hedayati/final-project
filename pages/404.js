  ...
  return (
    <div className="w-9/10 mx-auto flex flex-col items-center justify-center my-20 lg:flex-row-reverse lg:gap-20">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Link href="/torino" className="w-9/10 text-center mx-auto mt-3 cursor-pointer bg-green-200 text-green-500 rounded-md px-2 py-1 hover:bg-green-300 hover:text-green-600 lg:mt-7">
          بازگشت به صفحه اصلی
        </Link>
      </div>
    </div>
