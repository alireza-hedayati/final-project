  ...
  return (
    <div className="my-20" >
      ...
      <div className="flex items-center justify-center gap-5 mt-10">
        <button className="bg-green-500 cursor-pointer rounded-lg p-2 text-white hover:bg-green-600">جزییات خرید</button>
        <Link href="/torino" className="bg-green-500 cursor-pointer rounded-lg py-2 px-3 text-white hover:bg-green-600"> صفحه اصلی</Link>
      </div>
    </div>
  );
}
