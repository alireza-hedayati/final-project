...
function Card(props) {
  const { title, id, image, price, options } = props;
  return (
    <div className="border-2 border-gray-100 rounded-xl overflow-hidden my-4 bg-white shadow-md">
      <Link href={`torino/${id}`}>
        ...
        <div className="flex items-center justify-between py-3 px-2">
          <button className="border-none bg-green-500 px-4  rounded-sm text-center text-white cursor-pointer hover:bg-green-600">
            رزرو
          </button>
