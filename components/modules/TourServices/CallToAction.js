  ...
  return (
    <div className="w-7/10 mx-auto mt-7 md:mt-10">
      ...
      <div className="flex items-center justify-center mt-1">
        <Link aria-label="مشاهده-تورها" href="/torino" className="cursor-pointer bg-green-500 text-white border-0 rounded-md px-3 py-2 hover:bg-green-600">مشاهده ی تور های فعال</Link>
      </div>
    </div>
  );
}
