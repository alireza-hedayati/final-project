  ...
  return (
    <div className="border-t-2 border-gray-100 px-2 w-fit mx-auto lg:flex lg:items-center lg:mt-10 ">
      <div className="flex items-center my-5">
        <div className="relative w-[71px] h-[64px] xl:w-[99px] xl:h-[99px]">
          <Image src="/images/price.webp" fill alt="image" />
        </div>
        <div className="px-3">
      ...
      <div className="flex items-center my-5">
        <div className="relative w-[71px] h-[64px] xl:w-[99px] xl:h-[99px]">
          <Image src="/images/support.webp" fill alt="image" />
        </div>
        <div className="px-3">
      ...
      <div className="flex items-center my-5">
        <div className="relative w-[71px] h-[64px] xl:w-[99px] xl:h-[99px]">
          <Image src="/images/satisfaction.webp" fill alt="image" />
        </div>
        <div className="px-3">
